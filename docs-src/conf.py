...
source_dir = os.path.join(os.path.dirname(__file__), '..', 'biomodels_qc')
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..'))

# -- Project information -----------------------------------------------------
source_base_url = 'https://github.com/biosimulations/biomodels-qc/blob/dev/'
project = 'BioModels-QC'
...
html_theme_options = {
    ...
    'github_repo': 'biomodels-qc',
    'github_banner': True,
    'github_button': True,
    'description': 'Utilities for quality controlling the BioModels database',
    'fixed_sidebar': True,
